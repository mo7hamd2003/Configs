...
return {
  {
    ...
    priority = 1000, -- load before everything else to avoid flash
    config = function()
      require('kanagawa').setup {
        overrides = function(colors)
          ...
          return {
            ...
            ['@keyword'] = { fg = theme.syn.keyword, bold = true, italic = true },
            ['@type.builtin'] = { fg = theme.syn.type },
            ['@function'] = { fg = theme.syn.fun, bold = true, italic = true },
  ...
  -- Alternate colorscheme (lazy-loaded)
  {
