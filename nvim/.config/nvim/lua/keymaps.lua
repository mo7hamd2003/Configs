...
map('n', '<Leader>tn', '<cmd>tabnew<CR>', { silent = true, desc = '[T]ab [N]ew' })
map('n', '<Leader>tc', '<cmd>tabclose<CR>', { silent = true, desc = '[T]ab [C]lose' })
...
map('n', '<leader>tf', '<cmd>ToggleTerm direction=float<CR>', { desc = '[T]oggle [F]laoting' })
-- ============================================================
-- [[ Editing ]]
-- ============================================================
